...
const EMPLOYMENT_STATUS_OPTIONS_FR = {
  Employed: "Employé",
  Unemployed: "Sans emploi",
  "Self-employed": "Auto-employé",
  Retired: "Retraité",
  Student: "Étudiant",
  Other: "Autre",
};

function Step4({ setStep, demandePretId, clientId, setSelectedDossierId }) {
        ...
        >
          {EMPLOYMENT_STATUS_OPTIONS.map((option) => (
            <option key={option} value={option}>
              {EMPLOYMENT_STATUS_OPTIONS_FR[option]}
            </option>
          ))}
        </select>
